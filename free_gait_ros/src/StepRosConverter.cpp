                                   ...
                                   BaseAuto& baseAuto)
{
  ...
  if(message.has_nominal_pose){
    baseAuto.hasNominalTargetPose_ = message.has_nominal_pose;
    Pose nominalTargetPose;
    kindr_ros::convertFromRosGeometryMsg(message.nominal_pose, nominalTargetPose);
    baseAuto.nominalTargetPose_ = nominalTargetPose;
  } 
...
bool StepRosConverter::toMessage(const BaseAuto& baseAuto, free_gait_msgs::BaseAuto& message)
{
  ...
  if(baseAuto.hasNominalTargetPose_){
    geometry_msgs::Pose nominal_pose;
    kindr_ros::convertToRosGeometryMsg(baseAuto.nominalTargetPose_, nominal_pose);
    message.has_nominal_pose = baseAuto.hasNominalTargetPose_;
    message.nominal_pose = nominal_pose;
  } else {
    message.has_nominal_pose = false;
  }
