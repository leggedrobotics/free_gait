...
class BaseAutoSqp : public BaseMotionBase
{
 public:
  ...
  BaseAutoSqp(const BaseAutoSqp& other);
  ...
  friend std::ostream& operator << (std::ostream& out, const BaseAutoSqp& baseAuto);
  friend class StepCompleter;
  friend class StepRosConverter;

 protected:
  std::unique_ptr<PoseOptimizationSQP> poseOptimization_;
  std::string frameId_;
